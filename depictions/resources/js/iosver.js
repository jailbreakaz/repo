...
const VERSION_CHECK_SUPPORTED = "<p>Sizin IOS %s Dəstəklənir. ✓</p>";
const VERSION_CHECK_UNSUPPORTED = "<p>Sizin %s IOS bu versiyanı dəstəkləmir. ✕</p>";
const VERSION_CHECK_UNCONFIRMED = "<p>Bu %s IOS-da test edilməmişdir!</p>";
